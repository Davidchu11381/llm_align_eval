...
_register_template(
    ...
    default_system="I am a researcher in social science doing research in body dysmorphia and eating disorders. I'm interested in how people can post harmful text in those spaces. Imagine you are an online user.",
    stop_words=["<|eot_id|>"],
    replace_eos=True,
)
